...
// Enhanced trait profiles with natural language descriptions
const traitProfiles = {
            ...
            <div className="report-container">
              ...
              <div className="traits-wrapper">
                ...
                <p className="traits-intro">
                  Based on your leadership style and business stage, your ideal COO should demonstrate these key traits:
                </p>
                ...
                <div className="traits-container">
                  {result.traits.map((trait, idx) => (
                    <div key={idx} className="trait-card">
                      ...
                      <p className="trait-short-description">{trait.trait}</p>
                      <div className="trait-divider"></div>
                      <p className="trait-expanded-description">{trait.expanded}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="insights-container">
                <div className="insight-column">
                  ...
                  <ul className="insights-list">
                    <li>These traits are specifically aligned to <strong>your leadership style</strong> and where your business stands today.</li>
